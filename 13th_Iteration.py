# includes pickle.dump and pickle.load to store and retrive the label encoding each time , so that label encoding remains consistent each time 
...
if uploaded_file is not None:
    ...
    # Load the saved encoders to apply them to user data
